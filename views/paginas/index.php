...
<div class="contenedor seccion seccion-inferior">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="/entrada">
                    ...
                    <p>
                        Consejos para construir terraza en el techo de tu casa con los mejores materiales
                        y ahorrando dinero.
                    </p>
                </a>
            </div>
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="/entrada">
                    ...
                    <p>
                        Maximiza el espacio de tu hogar con esta guía, aprende a combinar muebles y
                        colores para daler vida a tú espacio.
                    </p>
                </a>
            </div>
        </article><!--.entrada.blog-->
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>El personal se comportó de una excelente forma, muy buena atención y la casa que
